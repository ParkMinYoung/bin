...
INTERVAL=/home/adminrig/workspace.min/IonTorrent/AccuteID.hosspot.rs/AccutID.rs.hotspot.bed.intervals
...
-L /home/adminrig/workspace.min/IonTorrent/SMC.KimJinKook.20121009.3samples/BAM/target.intervals \
--minBaseQuality 21						\
--outputFormat table					\
--printBaseCounts						\
-o AccuteID.DepthOfCoverage.report			\
