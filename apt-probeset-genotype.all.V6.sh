...
#CEL=cel-$DATE.txt
	...
	# for 6.0 array
	time apt-probeset-genotype -o $DIR  -c $CDF  -a birdseed-v2  --chrX-probes $X  --chrY-probes $Y  --read-models-birdseed $MODEL --special-snps $SPECIAL --force --set-gender-method cn-probe-chrXY-ratio  --summaries  --cel-files $CEL --write-models --use-disk false --disk-cache 800000 
	...
	#AffyChipSummary.sh
	/home/adminrig/src/short_read_assembly/bin/AffyChipSummary.txt.V6.sh
