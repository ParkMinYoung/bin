...
bwa aln -l $2 -k $3 $REF $1.1.ReadFilter.sanger.fastq > $1.1.ReadFilter.sanger.fastq.sai
bwa aln -l $2 -k $3 $REF $1.2.ReadFilter.sanger.fastq > $1.2.ReadFilter.sanger.fastq.sai
