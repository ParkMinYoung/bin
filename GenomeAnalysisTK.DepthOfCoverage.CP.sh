...
if [ $# -eq 0 ];then
    echo "usage : `basename $0` xxx.intervals yyy.fasta zzz.bam bam bam..."
...
>& $1.CP.DepthOfCoverage.log
GenomeAnalysisTK.DepthOfCoverage.table.sh $1.CP.DepthCoverage.Report.sample_interval_summary
