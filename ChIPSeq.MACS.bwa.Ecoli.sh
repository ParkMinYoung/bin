...
REF=/home/adminrig/Genome/E.coli/E.coli.BL21.fasta
...
if [ $# -eq 3 ]; then
        ...
        samtools view -uS  $Case.trimmed.fastq.SE.sam.gz | samtools sort - $Case.trimmed.fastq
        ...
        # covert SAM to BAM and perfrom sorting
        samtools view -uS  $Con.trimmed.fastq.SE.sam.gz | samtools sort - $Con.trimmed.fastq
