...
head -1 AnnoVarAnnotation.txt.tmp | perl -nle'$sub=join "\t", qw/Chr Bp Rs Ref Alt Qual Filter Data/;s/probeset_id/$sub/; print' > AnnoVarAnnotation.txt
sed -n '2,$p' AnnoVarAnnotation.txt.tmp >> AnnoVarAnnotation.txt

AnnoVarAnnotation.Genotype.sh > AnnoVarAnnotation.Genotype
