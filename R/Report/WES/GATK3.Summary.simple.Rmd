---
params:
    dynamictitle: "Whole Exome Seq. Simple Summary"
...
ggplot(df_step1,  aes( Sample, value)) + 
  geom_line( aes(group=Type),  col="darkblue", alpha=.1 ) +
  geom_point(aes(col="blue", fill=Type), size=2,shape=21) + 
  facet_grid(Type~., scales = "free") + 
  theme(axis.text.x = element_text(angle=90),
        strip.text = element_text( size = 10 , colour = "darkblue", face = "bold"),
        legend.position = "none") + 
  scale_y_continuous(expand = expand_scale(mult = c(1, .5))) 
