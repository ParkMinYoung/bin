...
#df1$time <- as.POSIXct(df1$access_time, tz="", format="%Y-%m-%d %H:%M:%S")
df1$time <- as.POSIXct(df1$hyb_fluidics_time, tz="", format="%Y-%m-%d %H:%M:%S")  
...
calendarHeat(plate$daystart, plate$out, date.form="%Y-%m-%d %H:%M:%S", varname="")
