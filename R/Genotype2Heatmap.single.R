...
mat<-as.matrix(con)
cc<-rep(rainbow(ncol(mat), start=0, end=1),each=1)

# https://rpubs.com/gaston/dendrograms
# prepare hierarchical cluster
hc = hclust(dist(t(con)))
# very simple dendrogram
png("ClusterDendrogram.png", height=800, width=1300)
plot(hc, xlab="Samples", sub="", main="Cluster Dendrogram")
dev.off()
