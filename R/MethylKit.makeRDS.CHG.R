...
objs<-processBismarkAln(location=files, sample.id=samples, assembly="hg19", save.folder=NULL, save.context=NULL, read.context="CHH", nolap=FALSE, mincov=10, minqual=20, phred64=FALSE, treatment=rep(0, length(samples)))



saveRDS(objs, "methylKit.CHG.RDS")
